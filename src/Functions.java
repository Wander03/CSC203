...
public final class Functions
{
    ...
    public static final String SAPLING_DESERT_KEY = "saplingDesert";
    ...
    public static final String DUDE_DESERT_KEY = "desert";
    ...
    public static final String FAIRY_KEY = "fairyForest";
    public static final String FAIRY_DESERT_KEY = "fairy";
    ...
    public static final String STUMP_DESERT_KEY = "stumpDesert";

    public static final String TREE_KEY = "tree";
    public static final String TREE_DESERT_KEY = "treeDesert";
    ...
    */
            ...
            String line, WorldModel world, ImageStore imageStore)
    {
        ...
        if (properties.length > 0) {
            switch (properties[PROPERTY_KEY]) {
                ...
                case DUDE_DESERT_KEY:
                    return parseDudeDesert(properties, world, imageStore);
                case OBSTACLE_KEY:
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == SAPLING_NUM_PROPERTIES) {
            ...
            Sapling entity = Factory.createSaplingForest(id, pt, imageStore.getImageList(SAPLING_KEY));
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == DUDE_NUM_PROPERTIES) {
            ...
            DudeNotFull entity = Factory.createDudeNotFullForest(properties[DUDE_ID],
                    pt,
    ...
    public static boolean parseDudeDesert(
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == DUDE_NUM_PROPERTIES) {
            Point pt = new Point(Integer.parseInt(properties[DUDE_COL]),
                    Integer.parseInt(properties[DUDE_ROW]));
            DudeNotFull entity = Factory.createDudeNotFullDesert(properties[DUDE_ID],
                    pt,
                    Integer.parseInt(properties[DUDE_ACTION_PERIOD]),
                    Integer.parseInt(properties[DUDE_ANIMATION_PERIOD]),
                    Integer.parseInt(properties[DUDE_LIMIT]),
                    imageStore.getImageList(DUDE_DESERT_KEY));
            world.tryAddEntity(entity);
        }
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == FAIRY_NUM_PROPERTIES) {
            ...
            Fairy entity = Factory.createFairyForest(properties[FAIRY_ID],
                    pt,
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == TREE_NUM_PROPERTIES) {
            ...
            Tree entity = Factory.createTreeForest(properties[TREE_ID],
                                        pt,
